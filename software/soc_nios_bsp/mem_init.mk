...
# Memory: onchip_memory_nios
MEM_0 := soc_nios
$(MEM_0)_NAME := onchip_memory_nios
...
$(MEM_0)_HIERARCHICAL_PATH := onchip_memory_nios
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: onchip_memory_nios
onchip_memory_nios: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
