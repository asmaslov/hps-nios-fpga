...
# setting hal.stderr is jtag_uart_nios
ELF_PATCH_FLAG  += --stderr_dev jtag_uart_nios

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart_nios
ELF_PATCH_FLAG  += --stdin_dev jtag_uart_nios
...
# setting hal.stdout is jtag_uart_nios
ELF_PATCH_FLAG  += --stdout_dev jtag_uart_nios
